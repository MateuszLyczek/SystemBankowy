...
import static SystemBankowy.DBConnect.SprawdzDane;
import static SystemBankowy.DBConnect.SprawdzHaslo;
import static SystemBankowy.DBConnect.polacz;
import static SystemBankowy.DBConnect.stworzTabele;
...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(414, 269));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String haslo = jTextField2.getText();
        //System.out.println(haslo);
        String imie = jTextField1.getText();
        //System.out.println(imie);
        if(SprawdzHaslo(imie, haslo)==true){
            SprawdzDane(imie);
            ...
            jLabel4.setText("Nieprawidłowe dane logowania");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            //jLabel4.setText(User.NazwaUzytkownika);
